  ...
  return (
    <div className={style.container} id='services'>
      <div className={style.info}>
        ...
        <Pulse>
        <h1 className={style.subtitle}>Other Services <hr></hr>Northern Virginia </h1>
        </Pulse>

        <hr className={style.hr}/>

        <div className={style.desc}><Image src='https://i.ibb.co/pd7DXKL/lawnals.png' width="400px" height="400px" objectFit="cover"></Image>
        <h4 className={style.text}>We also offer now management and seasonal yard cleanups services.</h4> 
        </div>
      ...
      >  
        ...
        <div className={style.Links}>
          ...
          <Link href='/allservices'><span>All Services</span></Link>
        </div>
        </div>
      </div>
    </div>
