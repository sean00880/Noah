  ...
  return (
    <div className={style.container} id='services'>
      <div className={style.info}>
        ...
        <Pulse>
        <h1 className={style.subtitle}>Our Installation Services <hr></hr>Northern Virginia </h1>
        </Pulse>

        <hr className={style.hr}/>

        <div className={style.desc}><Image src='https://i.ibb.co/pd7DXKL/lawnals.png' width="400px" height="400px" objectFit="cover"></Image>
        <h4 className={style.text}>We create, construct, and install unique hardscapes in NOVA, collaborating closely with each customer to come up with a design they'll enjoy. Depending on your preferences and requirements, we may construct anything from patios to walls to stone fireplaces and more as part of our hardscape services. Additionally, you'll have access to a skilled landscaping crew that creates each hardscape with careful planning and meticulous execution.</h4> 
        </div>
